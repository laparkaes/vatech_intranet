...
<section class="section profile">
    <div class="row">
        <div class="col-12">
            <div>
                <a href="<?= base_url('distributor') ?>" class="btn btn-primary mb-3"><i class="bi bi-arrow-left"></i> Lista</a>
                <a href="<?= base_url('distributor/edit/'.$distributor->id) ?>" class="btn btn-primary mb-3"><i class="bi bi-pencil"></i> Editar</a>
            </div>

            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Detalle de Distribuidor</h5>

                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label">Estado</label>
                            <input type="text" class="form-control <?= ($distributor->status == 1) ? 'text-success' : 'text-danger' ?>" value="<?= ($distributor->status == 1) ? 'ACTIVO' : 'INACTIVO' ?>" readonly>
                        </div>
                        
                        <div class="col-md-6">
                            <?php 
                            $aux = [];
                            if ($distributor->is_vendor) $aux[] = 'PROVEEDOR';
                            if ($distributor->is_dealer) $aux[] = 'DISTRIBUIDOR';
                            if (!$aux) $aux[] = "-";
                            ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" value="<?= $distributor->name ?>" readonly>
                        </div>
                        
                        <div class="col-md-4">
                            <label class="form-label">País</label>
                            <input type="text" class="form-control" value="<?= $distributor->country ?>" readonly>
                        </div>
                        
                        <div class="col-md-4">
                            <label class="form-label">Tax ID</label>
                            <input type="text" class="form-control" value="<?= $distributor->tax_id ?>" readonly>
                        </div>
                        
                        <div class="col-md-4">
                            <label class="form-label">Página Web</label>
                            <input type="text" class="form-control" value="<?= $distributor->website ?>" readonly>
                        </div>
                        
                        <div class="col-md-4">
                            <label class="form-label">Teléfono</label>
                            <input type="text" class="form-control" value="<?= $distributor->phone ?>" readonly>
                        </div>
                        
                        <div class="col-md-4">
                            <label class="form-label">Celular</label>
                            <input type="text" class="form-control" value="<?= $distributor->mobile ?>" readonly>
                        </div>
                        
                        <div class="col-md-4">
                            <label class="form-label">Registrado por</label>
                            <input type="text" class="form-control" value="<?= !empty($distributor->creator_name) ? $distributor->creator_name : 'Sistema / Desconocido' ?> (<?= $distributor->created_at ?>)" readonly>
                        </div>
                        
                        <div class="col-md-12">
                            <label class="form-label">Dirección</label>
                            <input type="text" class="form-control" value="<?= $distributor->address ? $distributor->address : "-" ?>" readonly>
                        </div>
                        
                        <div class="col-md-12">
                            <label class="form-label">Descripción / Notas</label>
                            <textarea class="form-control" style="height: 100px" readonly><?= $distributor->description ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="modal fade" id="addContactModal" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog">
                                <form action="<?= base_url('distributor/add_contact'); ?>" method="post" class="modal-content needs-validation" novalidate>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="btn-group" role="group">
                                                <?php if($co->is_main == 0): ?>
                                                <a href="<?= base_url('distributor/make_main_contact/'.$co->id.'/'.$distributor->id); ?>" 
                                                ...
                                                <a href="<?= base_url('distributor/delete_contact/'.$co->id.'/'.$distributor->id); ?>" 
...
<div class="modal fade" id="editContactModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url('distributor/update_single_contact'); ?>" method="post">
                <div class="modal-header">
