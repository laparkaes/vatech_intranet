			...
			<div class="card">
				<div class="card-body">
					...
					<form class="row needs-validation g-3" action="<?php echo base_url('division/add'); ?>" method="post" novalidate>
						<div class="col-md-12">
							<label for="inputDivision" class="form-label">Nombre</label>
							<input type="text" class="form-control" id="inputDivision" name="division_name" required>
							<div class="invalid-feedback">Campo obligatorio.</div>
						</div>
						<div class="col-md-12">
							<label for="inputDescription" class="form-label">Descripción</label>
							<textarea class="form-control" id="inputDescription" style="height: 100px" name="description" required></textarea>
							<div class="invalid-feedback">Campo obligatorio.</div>
						</div>
            ...
            <form action="<?php echo base_url('division/update'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
						...
						<textarea class="form-control" id="edit_desc" style="height: 100px" name="description" required=""></textarea>
                    </div>
