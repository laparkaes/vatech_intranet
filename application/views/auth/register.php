						...
						<div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
							<div class="card mb-3">
								<div class="card-body">
									...
									<form class="row g-3 needs-validation pt-3" action="<?php echo base_url('auth/register_process'); ?>" method="post" novalidate>
										<div class="col-12">
											<label for="yourName" class="form-label">Nombre Completo</label>
											<input type="text" name="full_name" class="form-control" id="yourName" 
												   placeholder="Fulanito Park" 
												   value="<?= $this->session->flashdata('old_full_name'); ?>" required>
										...
										<div class="col-12">
											...
											<div class="input-group has-validation">
												...
												<input type="email" name="email" class="form-control" id="yourUsername" 
													   placeholder="ejemplo@vatechglobal.com" 
													   value="<?= $this->session->flashdata('old_email'); ?>" required>
										...
										<div class="col-12">
											<p class="small mb-0"><a href="<?php echo base_url('auth'); ?>">Volver</a></a></p>
										</div>
									</form>
								</div>
							</div>
